                ...
                <div className="text-center px-8">
                    <div className="mb-6" data-aos="fade-down">
                        <div className="relative inline-flex before:absolute before:inset-0">
                            ...
                            href="https://www.linkedin.com/company/dotnova"
                            target="_blank"
                            >
                    ...
                    <h1 className="pb-4 font-extrabold tracking-tight text-transparent text-7xl lg:text-8xl  bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-600 to-yellow-400" data-aos="fade-down">
                        Edits Made Easy
                    </h1>
